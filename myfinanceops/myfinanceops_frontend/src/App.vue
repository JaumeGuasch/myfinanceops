    ...
    <nav class="nav py-4 px-6 border-b border-gray-200">
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
          <div class="menu-left">
            <router-link to="#" class="text-xl flex">
          ...
          <template v-if="isUserLoggedIn">
            <div class="menu-center absolute left-1/2 transform -translate-x-1/2 flex space-x-20">
              ...
              <router-link to="/hedging/" class="flex flex-col items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor"
                     class="w-8 h-8">
                  <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="menu-right">
              <router-link to="#" v-if="isUserLoggedIn"
                           style="font-style: normal; color: #000000; font-size: large; margin-right: 20px;">
                Hi, {{ userName }}
              </router-link>
              <router-link to="/logout" v-if="isUserLoggedIn" class="logout-button"
